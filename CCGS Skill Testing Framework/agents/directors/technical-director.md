...
**Model tier:** Leader (multi-document synthesis, high-stakes architecture and phase gate verdicts).
...
- [ ] Model tier is Leader per coordination-rules.md (directors with gate synthesis = Leader)
