...
`/patch-notes` is a Lightweight-tier skill that generates player-facing patch notes
...
3. Skill runs on Lightweight model — fast compilation
...
- [ ] Runs on Lightweight model tier (fast, low-cost)
