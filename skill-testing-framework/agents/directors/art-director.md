...
**Model tier:** Standard (note: despite the "director" title, art-director is assigned Standard per coordination-rules.md — it handles individual system analysis, not multi-document phase gate synthesis at the Leader level).
...
- [ ] Model tier is Standard (NOT Leader — coordination-rules.md assigns Standard to art-director)
